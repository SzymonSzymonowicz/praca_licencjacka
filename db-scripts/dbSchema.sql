...
CREATE TABLE IF NOT EXISTS `myexaminer`.`teaching_group` (
  ...
  teaching_group_date_of_starting DATETIME NOT NULL,
...
CREATE TABLE IF NOT EXISTS `myexaminer`.`exam` (
  ...
  exam_available_date DATETIME,
  exam_duration_time INT NOT NULL,
